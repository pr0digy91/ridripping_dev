  ...
  return (
    <div className="group bg-black rounded-2xl p-8 sm:p-12 shadow-2xl hover:shadow-[0_0_60px_rgba(0,0,0,0.3)] transition-all duration-500 hover:scale-[1.02] border border-black/20">
      <div className="flex flex-col gap-6">
        {/* Card Icon/Badge */}
        <div className="inline-flex w-16 h-16 bg-brand-yellow rounded-xl items-center justify-center transition-transform duration-300 group-hover:rotate-6 group-hover:scale-110">
